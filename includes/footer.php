            ...
            <div class="fms-info">
                ...
                <div class="fms-cards">
                    ...
                    <div class="fms-card">
                        ...
                        <div>
                            <div class="fms-card-label">Hotline hỗ trợ</div>
                            <div class="fms-card-value"><?php echo htmlspecialchars($_storeHotline); ?></div>
                        </div>
                    </div>
                    <div class="fms-card">
                        <div class="fms-card-icon"><i class="bi bi-envelope-fill"></i></div>
                        <div>
                            <div class="fms-card-label">Email</div>
