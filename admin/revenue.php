...
<div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4 gap-3">
    ...
    <div class="d-flex gap-2 align-items-center">
        ...
        <a href="export_revenue.php?filter=<?php echo $filter; ?>" class="btn btn-success btn-sm rounded-pill px-4 py-2 fw-bold shadow-sm d-inline-flex align-items-center gap-2 text-decoration-none ms-2">
